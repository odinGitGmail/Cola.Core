...
public static class StringExtensions
{
    ...
    public static JObject AddMailMark(this object entity, string fieldName, string newfieldName)
    {
        ...
        throw new ColaExceptionUtils(EnumException.RegexEmail);
    }
        ...
        string? strMark = null)
    {
        ...
        throw new ColaExceptionUtils(EnumException.RegexIdCardNumber);
    }
        ...
        string? strMark = null)
    {
        ...
        throw new ColaExceptionUtils(EnumException.RegexPhoneNumber);
    }
